  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-[#07101f] bg-[url('/ui/academy-hall.png')] bg-cover bg-center text-amber-50 font-sans select-none">
      ...
      {gameState !== GameState.SHOW_CARD && (
        <div className={`absolute top-3 left-3 right-3 md:top-6 md:left-6 md:right-auto z-40 flex flex-col items-start gap-3 max-w-[calc(100vw-1.5rem)] md:max-w-[22rem] max-h-[calc(100vh-1.5rem)] overflow-y-auto overscroll-contain pr-1 transition-all duration-500 ${peekMode ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
